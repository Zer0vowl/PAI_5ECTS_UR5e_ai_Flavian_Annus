...
def main():
    ...
    compute_cartesian = node.create_client(
            GetCartesianPath, "/compute_cartesian_path"
        )
    execute_traj = ActionClient(node, ExecuteTrajectory, "/execute_trajectory")
    ...
    # ------------------------------------------------------------------
    # 1) Move to START_Q in the same way as ai_dmp_moveit_controller.py
    # ------------------------------------------------------------------
    ...
    for i, pose in enumerate(waypoints):
        ...
        # update seed with the new solution to help continuity
    ...
    # Enable logging (for your EE trail logger)
